...
public class AutomationEmailableReport implements IReporter{
	
    private static final Logger LOG = Logger.getLogger(AutomationEmailableReport.class);
    ...
    protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>Emailable Automation Report</title>");
    ...
    protected void writeReportTitle(String title) {
        writer.print("<center><img src=\"http://www.spire2grow.com/main/sites/default/files/Spire%20logo%20unit%20_black_250_1.png\"></center> <center><h1>" + title + " - " + getDateAsString() + "</h1></center>");
    }
    ...
    protected void writeSuiteSummary() {
        ...
        for (SuiteResult suiteResult : suiteResults) {
            ...
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                /*String propName=SpireProperties.loadProperties().getProperty(suiteName);*/
                ...
                writeTableData(buffer
                        .append(Utils.escapeHtml(testResult.getTestName())).toString());
    ...
    public List<MethodResult> removeFailedTest(List<MethodResult> methods){
    	...
    	List<MethodResult> newMethods = new ArrayList<AutomationEmailableReport.MethodResult>();
    	int i=0;
