...
import com.automation.report.controller.Context;
import com.automation.report.controller.ContextManager;
 ...
 * </p>
 */
public class AutomationReport implements IReporter, ITestListener {
	...
	protected void writeBody() {
		...
		writeReportTitle("<font color=\"Grey\">Automation Report");
		writeSuiteSummary();
	...
	protected void writeReportTitle(String title) {
		writer.print(
				"<center><img src=\"data:image/png;base64,\"></center> <center><h1>"
	...
	protected void writeSuiteSummary() {
		...
		if (testIndex >= 1) {
			...
			writeTableData(decimalFormat.format((((double) totalPassedTests / (double) totalTests)) * 100) + "%",
					"num");
	...
	public List<MethodResult> removeFailedTest(List<MethodResult> methods) {
		...
		List<MethodResult> newMethods = new ArrayList<AutomationReport.MethodResult>();
		int i = 0;
			...
			for (ITestResult iTestResult : results) {
				...
				for (ITestResult list : newList) {
					...
					if (list != null && list.getParameters() != null && list.getParameters().length > 0) {
						...
						if ((list.getParameters()[0].toString())
	...
	protected static class TestResult {
		...
		public TestResult(ITestContext context) {
			...
			Set<ITestResult> failedConfigurations = ignorePassedTests(passedTests,
					deleteDuplicates(context.getFailedConfigurations().getAllResults()));

			Set<ITestResult> failedTests = ignorePassedTests(passedTests,
					deleteDuplicates(context.getFailedTests().getAllResults()));

			// failedTests=deleteDuplicates(failedTests);

			Set<ITestResult> skippedConfigurations = ignorePassedTests(passedTests,
					deleteDuplicates(context.getSkippedConfigurations().getAllResults()));
			Set<ITestResult> skippedTests = ignorePassedTests(passedTests,
					deleteDuplicates(context.getSkippedTests().getAllResults()));
				...
				for (ITestResult result : newSet) {
					...
					if (result != null && result.getParameters() != null && result.getParameters().length > 0) {
						...
						if (iTestResult.getParameters() != null && iTestResult.getParameters().length > 0) {
							...
							if ((result.getParameters()[0].toString())
									.equalsIgnoreCase(iTestResult.getParameters()[0].toString())) {
								isDuplicate = true;
							}
				...
				for (ITestResult result : testResults) {
					...
					if (result != null && result.getParameters() != null && result.getParameters().length > 0) {
						...
						if (pTest.getParameters() != null && pTest.getParameters().length > 0) {
							...
							if ((result.getParameters()[0].toString())
									.equalsIgnoreCase(pTest.getParameters()[0].toString())) {
